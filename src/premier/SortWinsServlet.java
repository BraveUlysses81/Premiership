...
/**
 * Servlet implementation class SortWinsServlet
 */
@WebServlet("/SortWinsServlet")
public class SortWinsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortWinsServlet() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		ArrayList <Person> persons = PersonDB.winsPeople();
